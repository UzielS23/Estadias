...
document.addEventListener('DOMContentLoaded', function () {
    document.getElementById('pickFuseBtn').addEventListener('click', function () {
        ...
        const selectedValue = selectElement.value;
            sendMQTTMessage4(selectedValue);
